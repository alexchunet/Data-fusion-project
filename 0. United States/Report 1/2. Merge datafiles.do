capture log close
log using "C:\Users\WB459082\Desktop\DECAT\0. United States\Report 1\log Merge datafiles.txt", replace text
/*==================================================
...
drop _all
clear all
cd "C:\Users\WB459082\Desktop\DECAT\0. United States\Report 1\"
...
*----------3.2: PCA Count: This is the simple addition of all of the mention counts (two of the variables are completely empty). 
...
*----------5.1: Summary
			...
			sum pc1_dummies pc1_counts count unemployment_rate

*----------5.2: Correlation

			corre pc1_dummies pc1_counts count unemployment_rate

*----------5.2: Regressions

			local controls "unemployment_rate"
